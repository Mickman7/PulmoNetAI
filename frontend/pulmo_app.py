...
st.title("🫁 Pulmo")
st.write(
    "Multimodal pneumonia detection assistant. Use the sidebar to:\n\n"
    "- **Create Patient** — register a new patient with medical history\n"
    "- **Predict** — search a patient, upload an X-ray + notes/labs, run the model\n"
    "- **Agent** — search a patient, select past predictions, generate an AI report"
)
